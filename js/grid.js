	...
	Preview.prototype = {
		create : function() {
			...
			if (settings.showVisitButton === true) {                                
				this.$git   = $( '<a href="#" target="_blank">View Github</a>' );
				this.$video = $( '<a href="#" target="_blank">Watch Video</a>' );
				this.$href  = $( '<a href="#" target="_blank">Visit website</a>' );
				detailAppends.push(this.$git);
				detailAppends.push(this.$video);
		...
		update : function( $item, $anchor ) {
			...
			if (settings.showVisitButton === true) {
				this.$href.attr( 'href', eldata.href );
                                this.$git.attr( 'href', eldata.git );
                                this.$video.attr( 'href', eldata.video );
                                this.$href.css('display', 'table');
                                this.$git.css('display', 'table');
                                this.$video.css('display', 'table');
                                if (!eldata.href) {
                                    this.$href.css('display', 'none');
                                }
                                if (!eldata.git) {
                                    this.$git.css('display', 'none');
                                }
                                if (!eldata.video) {
